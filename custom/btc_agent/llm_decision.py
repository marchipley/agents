...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        "VOLATILITY RATIO RULE: You are strictly prohibited from evaluating any trade with a confidence higher than 0.55 if DISTANCE_FROM_STRIKE_USD is less than active volatility_5m when time_remaining_seconds > 90. Strong momentum flags can easily flip into mean reversion when the structural price cushion is narrower than baseline variance parameters.\n"
        ...
        "EXHAUSTION REVERSION RULE: If t < 90, you are evaluating an UP trade, and rsi9 > 70, expect a temporary pullback. You MUST have a DISTANCE_FROM_STRIKE_USD > 20.0 to proceed. If the cushion is < 20.0, output NO_TRADE.\n"
