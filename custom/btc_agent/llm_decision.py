...
def _build_system_prompt() -> str:
    ...
    return (
        ...
        f"If time_remaining_seconds > 180, you are in the Discovery Phase. If ADX < {cfg.discovery_adx_caution_threshold:.0f}, stay cautious. If ADX > {cfg.trend_priority_adx_threshold:.0f}, prioritize the trend over the time elapsed.\n"
...
def _build_user_prompt(features: BtcFeatures, market: BtcUpDownMarket, up_snapshot=None, down_snapshot=None) -> str:
    ...
    return (
        ...
        f"- If time_remaining_seconds > 180, you are in the Discovery Phase. If ADX < {cfg.discovery_adx_caution_threshold:.0f}, stay cautious. If ADX > {cfg.trend_priority_adx_threshold:.0f}, prioritize the trend over time elapsed.\n"
...
def _build_minimal_user_prompt(features: BtcFeatures, market: BtcUpDownMarket, up_snapshot=None, down_snapshot=None) -> str:
    ...
    return (
        ...
        f"t is authoritative; final 10 seconds means t<15; if t>180 and adx14<{cfg.discovery_adx_caution_threshold:.0f} stay cautious, if adx14>{cfg.trend_priority_adx_threshold:.0f} prioritize trend over elapsed time.\n"
...
def _build_openai_realtime_user_prompt(
    ...
    return (
        ...
        "t_is_authoritative;"
        f"if_t_gt_180_and_adx_lt_{cfg.discovery_adx_caution_threshold:.0f}_discovery_caution_if_adx_gt_{cfg.trend_priority_adx_threshold:.0f}_prioritize_trend;"
